 ...
 */
@WebServlet("/HibernateDetailsServletTwo")
public class HibernateDetailsServletTwo extends HttpServlet {
    private static final long serialVersionUID = 1L;
    public HibernateDetailsServletTwo() {
        super();
        ...
        try {
            ...
            for(EProduct p: list) {
               ...
               // out.println("<br>Description:" + descrip.getDescrip());
                out.println("<br>TO DO: implement product description mapping.") ;
                out.println("<hr>");
            }
